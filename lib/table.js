...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(4), __webpack_require__(6).setImmediate))
...
/* harmony default export */ var table_header = ({
    ...
    render: function render(h) {
        ...
        var columnRows = convertToRows(this.columns);
        ...
        return h(
            ...
            [h('colgroup', [this.columns.map(function (column) {
                return h('col', {
                    ...
                    key: column.id });
            })]), h('thead', [h('tr', [this._l(columnRows, function (column, cellIndex) {
                return h(
                    'th',
                    {
                        key: cellIndex,
